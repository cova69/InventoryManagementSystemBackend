        ...
        http
            ...
            .authorizeHttpRequests(auth -> 
                auth.requestMatchers("/api/auth/**").permitAll()
                    ...
                    .requestMatchers("/api/test/manager").hasAnyAuthority("MANAGER", "ADMIN")
                    ...
                    .requestMatchers(HttpMethod.POST, "/api/suppliers/**").hasAnyAuthority("ADMIN", "MANAGER")
                    .requestMatchers(HttpMethod.PUT, "/api/suppliers/**").hasAnyAuthority("ADMIN", "MANAGER")
                    .requestMatchers(HttpMethod.DELETE, "/api/suppliers/**").hasAnyAuthority("ADMIN", "MANAGER")
                    .requestMatchers(HttpMethod.POST, "/api/inventory/**").hasAnyAuthority("ADMIN", "MANAGER")
                    .requestMatchers(HttpMethod.PUT, "/api/inventory/**").hasAnyAuthority("ADMIN", "MANAGER")
                    .requestMatchers(HttpMethod.DELETE, "/api/inventory/**").hasAnyAuthority("ADMIN", "MANAGER")
